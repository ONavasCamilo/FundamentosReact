...
export default function Estilos() {
    ...
    return (
        <section className="estilos">
            ...
            <h3 className={moduleStyles.error}>Estilos con Módulos moduleStyles.error</h3>
            <h3 className={moduleStyles.success}>Estilos con Módulos moduleStyles.success</h3>
